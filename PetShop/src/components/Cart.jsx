...
import { getMockCart, removeMockCartItem, updateMockCartItem, setMockCart } from '../data/mockData';
...
const Cart = ({ sessionId, onClose, onCheckout }) => {
  ...
  const updateQuantity = async (itemId, newQuantity) => {
    ...
    try {
      await axios.put(buildApiUrl(`/api/cart/${itemId}`), {
      ...
      console.warn('Backend not available, using mock cart:', err.message);
      // Fallback to mock cart
      updateMockCartItem(itemId, newQuantity);
      fetchCartItems();
    }
  };
